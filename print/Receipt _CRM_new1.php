...
LEFT JOIN tbl_branch e ON e.branch_id = d.branch_id	
 WHERE a.job_id = '$job_id'";
    ...
    $receipt_no = $row_customer['receipt_no'];
...
LEFT JOIN tbl_branch e ON e.branch_id = d.branch_id
 WHERE a.job_id = '$job_id'";
    ...
    if (isset($sql_customer['signature_image'])) {
        $img_string = $sql_customer['signature_image'];
...
$pdf->SetXY(0, 0); //เลขที่ใบเสร็จรับเงิน
$pdf->MultiCell(2.7, 4.2, iconv('UTF-8', 'cp874', $receipt_no), 0, 'R', 0);
