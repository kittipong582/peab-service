...
<div class="wrapper wrapper-content">
                ...
                <div class="ibox">
                    <div class="ibox-title" style="padding: 15px 15px 8px 15px;">
                        ...
                        <div class="ibox-tools">
                            <button class="btn btn-sm btn-primary" onclick="GetModalAudit()"><i class="fa fa-plus"></i>
                                เพิ่ม</button>
                        </div>
                        <!-- <div class="">
    ...
    <script>
        ...
        function LoadTable() {
            $.ajax({
                type: 'POST',
                url: "ajax/audit_list/GetTable.php",
                data: {
        ...
        function GetModalAudit() {
            $("#modal").modal("show");
            $("#showModal").load("ajax/audit_list/modal_addlist.php");
        }
        ...
        function GetModalEdit(audit_id) {
            $("#modal").modal("show");
            $("#showModal").load("ajax/audit_list/modal_edit.php", {
                audit_id: audit_id,

            });
        }

        function DeleteList(audit_id) {
            swal({
                ...
                $.ajax({
                    type: "POST",
                    url: "ajax/audit_list/delete.php",
                    data: {
                        audit_id: audit_id
                    },
                    dataType: "json",
        ...
        //     }, function () {
        //         $.ajax({
        //             url: 'ajax/audit_choice_list/SortFile.php',
        //             type: 'POST',
        //             data: {
