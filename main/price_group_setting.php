...
<script>
    ...
    function GetTable() {
        $.ajax({
            url: "ajax/customer_group/GetTable.php",
            dataType: "html",
    ...
    function ModalAdd() {
        $.ajax({
            url: "ajax/customer_group/ModalAdd.php",
            dataType: "html",
            success: function(response) {
    ...
    function ModalEdit(customer_group_id) {
        $.ajax({
            type: "POST",
            url: "ajax/customer_group/ModalEdit.php",
            data: {
    ...
    function Add() {
        ...
        swal({
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "ajax/customer_group/Add.php",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
    ...
    function Update() {
        ...
        swal({
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "ajax/customer_group/Update.php",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
    ...
    function ChangeStatus(customer_group_id) {
        $.ajax({
            type: "post",
            url: "ajax/customer_group/ChangeStatus.php",
            data: {
                customer_group_id: customer_group_id,
            },
            dataType: "json",
