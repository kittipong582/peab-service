...
function AddExpend() {
    $('#myModal').modal('show');
    $('#showModal').load("ajax/account/FormAdd.php", function() {
        ...
        $("#AddFormSubmit").click(function() {
            ...
            if (bank_name == "" || account_no == "" || account_name == "" || bank_branch_name == "" || account_type == "") {
                swal({
                    title: 'แจ้งเตือน',
...
function EditExpend(account_id) {
    $('#myModal').modal('show');
    $('#showModal').load("ajax/account/FormEdit.php", {
...
function Update() {
    ...
    const account_id = $("#bank_id").val();
    const bank_name = $("#bank_name").val();
    const account_no = $("#account_no").val();
    const account_name = $("#account_name").val();
    const bank_branch_name = $("#bank_branch_name").val();
    const account_type = $("#account_type").val();

    if (bank_id == "" || bank_name == "" || account_no == "" || account_name == "" || bank_branch_name == "" || account_type == "") {
