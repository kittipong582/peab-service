...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>นำเข้าราคาอะไหล่ของกลุ่ม<?php echo $row_group['customer_group_name'] ?></h2>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>นำเข้าราคาอะไหล่ของกลุ่ม<?php echo $row_group['customer_group_name'] ?></strong>
            </li>
        </ol>
    </div>
    ...
    <div class="ibox">
        ...
        <div class="ibox-content">
            <div class="row mb-3">
                <div class="col-4"></div>
                <div class="col-2">
                    <button type="button" onclick="export_spare_price_group('<?php echo $customer_group_id ?>');" class="btn btn-primary btn-sm"> โหลดข้อมูลอะไหล่ </button>
                </div>
                <div class="col-2">
                    <button type="button" onclick="export_all_spare_price('<?php echo $customer_group_id ?>');" class="btn btn-primary btn-sm"> โหลดข้อมูลอะไหล่ทั้งหมด </button>
                </div>
                <div class="col-4"></div>
            </div>
...
<script>
    ...
    function upload_file() {
        ...
        swal({
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax/import/spare_price_group/import_spare_price.php',
                data: formData,
                processData: false,
                contentType: false,
                dataType: 'json',
                    ...
                    if (data.result == 1) {
                        ...
                        toastr.options = {
                            ...
                            onHidden: function() {
                                ...
                                window.location.href = 'customer_spare_price.php?id=' + customer_group_id;
                            }
                        };
    ...
    function export_spare_price_group(customer_group_id) {


        var redirect = 'ajax/report/spare_price_group/export_spare_price_group.php';
    ...
    function export_all_spare_price(customer_group_id) {


        var redirect = 'ajax/report/spare_price_group/export_all_spare_price.php';
