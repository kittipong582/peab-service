    ...
    <div class="ibox">
        <div class="ibox-title">
            <div class="ibox-tools">
                <button type="button" class="btn btn-xs btn-primary" onclick="ModalAdd();"><i class="fa fa-plus"></i>
                    เพิ่มสินค้า QC</button>


                <button type="button" class="btn btn-xs btn-info" onclick="ImportData();"><i class="fa fa-upload"></i>
                    Import</button>
                <a href="/file/PBT_IN-OUT Report.xlsx" target="_blank" rel="noopener noreferrer" download><button
                        type="button" class="btn btn-xs btn-success"><i class="fa fa-download"></i> Import
                        Form</button></a>
            </div>
        </div>
