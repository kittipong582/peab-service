    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a href="report_performance.php">รายงานเครื่อง</a>
            </li>
...
<div class="wrapper wrapper-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="team_id" name="team_id" data-width="100%">
                                        <option value="">ทั้งหมด</option>
                                        <?php while ($row_team = mysqli_fetch_array($rs_team)) { ?>
    ...
    <script>
        ...
        function export_overall() {
            ...
            var redirect = 'ajax/report/product/export_product.php';
