...
$job_id = mysqli_real_escape_string($connect_db, $_GET['job_id']);
...
<div class="wrapper wrapper-content">
    ...
    <script>
        ...
        function GetTable() {
            ...
            $.ajax({
                type: 'POST',
                url: "ajax/audit_evaluation/GetTable.php",
                data: {
                    job_id: job_id,
                    audit_id: audit_id,
        ...
        function GetModalPic(record_id) {
           
            $.ajax({
                type: "POST",
                url: "ajax/audit_evaluation/Modal_Picture.php",
                dataType: "html",
                data: {
                    record_id: record_id
                },
