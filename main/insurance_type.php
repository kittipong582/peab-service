...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12" style="margin-left: 20px;">
        <h2>ตั้งค่าประกันอะไหล่</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="index.php">หน้าหลัก</a>
            </li>
            <li class="breadcrumb-item">
                <a href="insurance_type.php">ตั้งค่าประกันอะไหล่</a>
            </li>
...
<script>
    ...
    function GetTable() {
        $.ajax({
            type: 'POST',
            url: "ajax/insurance_type/GetTable.php",
            dataType: "html",
    ...
    function Modal_Add() {
        $.ajax({
            url: "ajax/insurance_type/ModalAdd.php",
            dataType: "html",
            success: function(response) {
    ...
    function Modal_Edit(warranty_type_id) {
        $.ajax({
            type: "post",
            url: "ajax/insurance_type/ModalEdit.php",
            data: {
    ...
    function Update() {
        ...
        const warranty_type_name = $("#warranty_type_name").val();

        if (warranty_type_name == "") {
        ...
        swal({
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "ajax/insurance_type/Update.php",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
    ...
    function ChangeStatus(button, warranty_type_id) {
        $.ajax({
            type: "post",
            url: "ajax/insurance_type/ChangeStatus.php",
            data: {
                warranty_type_id : warranty_type_id 
            },
            dataType: "json",
    ...
    function Add() {
        ...
        var tbl_warranty_type = $("#tbl_warranty_type").val();


        if (tbl_warranty_type == "") {
        ...
        swal({
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "ajax/insurance_type/Add.php",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
