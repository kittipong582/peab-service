    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a href="report_overall.php">รายงาน ภาพรวม</a>
            </li>
...
<div class="wrapper wrapper-content">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                                    ...
                                    <select class="form-control select2" id="product_type" name="product_type"
                                        ...
                                        while ($row_t = mysqli_fetch_assoc($rs_t)) {
                                            ...
                                            <option value="<?php echo $row_t['type_id'] ?>">
                                                <?php echo $row_t['type_code'] . " - " . $row_t['type_name'] ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 text-center">
                                <input class="btn btn-md btn-info btn-block" type="button" onclick="export_overall3();"
                                    value="สร้างรายการเเยกเครื่อง">
                            </div>
                            <div class="col-md-2 text-center">
                                <input class="btn btn-md btn-info btn-block" type="button"
                                    onclick="export_overallsttaff();" value="สร้างรายการแยกช่าง">
                            </div>
                        </div>
    ...
    <script>
        ...
        function export_overall() {
            ...
            var redirect = 'ajax/report/overall/export_overall.php';
        ...
        function export_overallsttaff() {
            ...
            var redirect = 'ajax/report/overall/export_overallstaff.php';
