                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <?php if ($admin_status == 9 || $row_user['user_level'] == 4) { ?>
                        <li <?php if ($pagename == 'index_user_team.php' || $pagename == "index_sparepart.php") {
                            ...
                            <a href="javascript:void(0);"><i class="fa fa-database"></i> <span class="nav-label">Dashboard</span><span class="fa arrow"></span></a>
                    ...
                    <li <?php if (
                        ...
                        <a href="javascript:void(0);"><i class="fa fa-database"></i> <span class="nav-label">ระบบคลัง
                            ...
                            <?php if ($row_user['user_level'] == 2 && $row_import['remain_import'] > 0 || $row_user['user_level'] == 2 && $row_transfer['remain_transfer'] > 0) { ?><span class="badge badge-danger float-right">!</span>
                            <?php } ?>
                        </a>
                            ...
                            <?php if ($row_user['user_level'] == 2) { ?>
                                <li class="<?php if ($pagename == 'confirm_import.php') {
                                    ...
                                    <a href="confirm_import.php"><i class="fa fa-check"></i><i class="fa fa-download"></i>
                                        ยืนยันการเบิก
                                        <?php if ($row_import['remain_import'] > 0) { ?><span class="badge badge-danger float-right">
                            ...
                            <?php if ($row_user['user_level'] == 2) { ?>
                                <li class="<?php if ($pagename == 'confirm_transfer.php') {
                                    ...
                                    <a href="confirm_transfer.php"><i class="fa fa-check"></i><i class="fa fa-exchange"></i>
                                        รับโอน
                                        <?php if ($row_transfer['remain_transfer'] > 0) { ?><span class="badge badge-danger float-right">
                    ...
                    <li <?php if ($pagename == 'report_repair_list.php' || $pagename == 'report_repair_job.php') {
                        ...
                        <a href="javascript:void(0);"><i class="fa fa-database"></i> <span class="nav-label">แจ้งซ่อม</span><span class="fa arrow"></span></a>
                    ...
                    <li <?php if ($pagename == 'audit_report.php' || $pagename == 'audit_report.php') {
                        ...
                        <a href="javascript:void(0);"><i class="fa fa-database"></i> <span class="nav-label">งานAudit</span><span class="fa arrow"></span></a>
                    ...
                    <?php if ($admin_status == 9) { ?>
                        ...
                        <li <?php if ($pagename == 'index_vender.php') {
                            ...
                            <a href="index_vender.php"><i class="fa fa-users"></i> <span class="nav-label">ผู้ใช้งานระบบ(Vender)</span></a>
                        </li>
                        ...
                        <li <?php if ($pagename == 'import_product.php' || $pagename == 'import_product.php') {
                                echo 'class="active"';
                            } ?>>

                            <a href="javascript:void(0);"><i class="fa fa-database"></i> <span class="nav-label">สินค้ารอ QC</span><span class="fa arrow"></span></a>
