...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a href="audit_checklist.php">รายการ Audit </a>
            </li>
            <li class="breadcrumb-item active">
...
<div class="wrapper wrapper-content">
    ...
    <script>
        ...
        function GetModalChoiceAddList(topic_id) {
            ...
            $.ajax({
                type: "POST",
                url: "ajax/audit_choice_list/modal_addlist.php",
                dataType: "html",
                data: {
                    topic_id: topic_id
                },
        ...
        function GetModalEdit(topic_id, checklist_id) {
            ...
            $.ajax({
                type: "POST",
                url: "ajax/audit_choice_list/modal_editlist.php",
                dataType: "html",
                data: {
                    topic_id: topic_id,
                    checklist_id: checklist_id
        ...
        function DeleteList(checklist_id, topic_id) {
            swal({
