...
<div class="wrapper wrapper-content">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-md-2 text-center">
                                <input class="btn btn-md btn-info btn-block" type="button" onclick="export_user_repeat_repair();" value="สร้างรายการ">
                            </div>
                        </div>
    ...
    <script>
        ...
        function export_user_repeat_repair() {
            var team = $('#team').val();
            var staff = $('#staff').val();
            var redirect = 'ajax/report/repeat_repair/export_user_repeat_repair.php';
