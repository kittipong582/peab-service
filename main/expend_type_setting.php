...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12" style="margin-left: 20px;">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="expend_type_setting.php">ประเภทค่าใช้จ่าย</a>
            </li>
...
function EditExpend(expend_type_id) {
    $('#myModal').modal('show');
    $('#showModal').load("ajax/settingExpend/FormEdit.php", {
...
function Update() {
    ...
    const expend_code = $("#expend_code").val();
    const expend_type_name = $("#expend_type_name").val();
    const description = $("#description").val();

    if (expend_code == "" || expend_type_name == "" || description == "") {
    ...
    swal({
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "ajax/settingExpend/Update.php",
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
