...
<script>
    ...
    function GetTable() {
        ...
        $.ajax({
            type: "post",
            url: "ajax/product_edit_manual_sub/GetTable.php",
            dataType: "html",
            data: {
                manual_id: manual_id
            },
    ...
    function ModalAdd() {
        ...
        const manual_id = urlParams.get('id');
        $.ajax({
            url: "ajax/product_edit_manual_sub/ModalAdd.php",
            data: {
                manual_id: manual_id
            },
            dataType: "html",
    ...
    function ModalEdit(manual_sub_id) {
        ...
        $.ajax({
            type: "post",
            url: "ajax/product_edit_manual_sub/ModalEdit.php",
            data: {
    ...
    function Add() {
        ...
        swal({
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax/product_edit_manual_sub/Add.php',
                data: formData,
                processData: false,
                contentType: false,
                dataType: 'json',
    ...
    function Update() {
        ...
        swal({
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax/product_edit_manual_sub/Update.php',
                data: formData,
                processData: false,
                contentType: false,
                dataType: 'json',
