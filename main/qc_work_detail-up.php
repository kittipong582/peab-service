                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                while ($row_qc_id = mysqli_fetch_assoc($res_qc_id)) {
                                   $sql_topic = "SELECT * 
                            FROM tbl_qc_form a
                            LEFT JOIN tbl_qc_topic b ON a.qc_id = b.qc_id WHERE a.product_type_id = '4' ORDER BY b.create_datetime ASC";
                                ...
                                ?>
                                        ...
                                        <tbody>
                                            ...
                                            $sql_checklist = "SELECT a.checklist_name,a.topic_qc_id, b.score,b.record_id,b.text_score, c.score_name, d.topic_detail,d.topic_qc_id FROM tbl_qc_checklist a LEFT JOIN tbl_qc_record b ON a.checklist_id = b.checklist_id LEFT JOIN tbl_qc_score c ON b.score = c.score AND b.checklist_id = c.checklist_id LEFT JOIN tbl_qc_topic d ON d.topic_qc_id = a.topic_qc_id WHERE b.job_qc_id = '$job' AND d.topic_qc_id = '{$row_topic['topic_qc_id']}' ORDER BY a.create_datetime ASC ";
                                            $res_checklist = mysqli_query($connect_db, $sql_checklist);
                                            // $sql_checklisthead = "SELECT  a.checklist_name,a.checklist_id, b.score,b.record_id,b.text_score, c.score_name 
                                            //      FROM tbl_qc_checklist a 
                                            //      LEFT JOIN tbl_qc_record b ON a.checklist_id = b.checklist_id 
                                            //      LEFT JOIN tbl_qc_score c ON b.score = c.score AND b.checklist_id = c.checklist_id 
                                            //      WHERE b.job_qc_id = '$job' ORDER BY a.create_datetime ASC";
                                            // $res_checklisthead = mysqli_query($connect_db, $sql_checklisthead);
                                            // $row_checklisthead = mysqli_fetch_assoc($res_checklisthead);
                                            //                 
                                            ?>
                                            <?php
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <?php
                                            if ($row_p_all['fail'] != '0') {
                                                echo '<a href="" type="button" class="btn btn-xs btn-warning ">ส่งซ่อม</a>';
                                            }
