...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>ประเภทงานอื่นๆ</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="index.php">หน้าแรก</a>
            </li>
            <li class="breadcrumb-item active">
                <strong>ประเภทงานอื่นๆ</strong>
            </li>
        </ol>
    </div>
...
<script>
    ...
    function GetTable() {
        $.ajax({
            type: 'POST',
            url: "ajax/oth_job_type/GetTable.php",
            dataType: "html",
    ...
    function ModalAdd() {
        $.ajax({
            url: "ajax/oth_job_type/ModalAdd.php",
            dataType: "html",
            success: function(response) {
    ...
    function Add() {
        ...
        var oth_type_name = $("#sub_type_name").val();
    ...
    function ModalEdit(oth_type_id) {
        $.ajax({
            type: "post",
            url: "ajax/oth_job_type/ModalEdit.php",
            data: {
                oth_type_id: oth_type_id
            },
            dataType: "html",
            success: function(response) {
                $("#modal .modal-content").html(response);
...
if (oth_type_name == "") {
    ...
    return false;
        ...
        swal({
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "ajax/oth_job_type/Update.php",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
    ...
    function ChangeStatus(button, oth_type_id) {
        $.ajax({
            type: "post",
            url: "ajax/oth_job_type/ChangeStatus.php",
            data: {
                oth_type_id: oth_type_id
            },
            dataType: "json",
