...
$sql = "SELECT frm.qc_id 
,top.topic_qc_id
,top.create_datetime
,chk.checklist_id
,chk.topic_qc_id
,chk.list_order 
FROM tbl_qc_form frm 
LEFT JOIN tbl_qc_topic top ON frm.qc_id = top.qc_id 
LEFT JOIN tbl_qc_checklist chk ON top.topic_qc_id = chk.topic_qc_id 
WHERE frm.qc_id ='5470660858'
ORDER BY frm.qc_id , top.topic_qc_id ASC ,top.create_datetime ASC , chk.list_order ASC";
...
while ($row = mysqli_fetch_assoc($res)) {
    ...
    $sql_update = "UPDATE tbl_qc_checklist SET  
        list_order = '$list'
