...
$link_manual = mysqli_real_escape_string($connect_db, $_POST['link_manual']);
$remark = mysqli_real_escape_string($connect_db, $_POST['remark']);
$manual_id = mysqli_real_escape_string($connect_db, $_POST['manual_id']);

$sql = "SELECT MAX(list_order) as last_list_order FROM tbl_manual_sub WHERE manual_id = '$manual_id'";
...
$sql_insert = "INSERT INTO tbl_manual_sub SET 
