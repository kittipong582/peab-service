...
$sql = "SELECT * FROM tbl_manual_sub WHERE manual_sub_id = '$manual_sub_id'";
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <input type="text" class="form-control mb-3" id="link_manual" name="link_manual" value="<?php echo $row['link_manual'] ?>">
            </div>
