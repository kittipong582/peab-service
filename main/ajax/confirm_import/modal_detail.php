...
$sql = "SELECT a.*,b.fullname AS bname ,c.branch_name AS cname FROM tbl_import_stock a 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-6">
                            <div class="form-group ">
                                ...
                                <label><?php echo $row['bname'] ?></label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-xs-6">
                            <div class="form-group ">
                                <label><b>ทีมผู้รับ</b></label><br>
                                <label><?php echo $row['cname']; ?></label>
                            </div>
                        </div>
