...
if ($admin_status == 9 || $user_level == 4) {
    $sql = "SELECT a.*,b.spare_type_name,c.remain_stock,c.branch_id,e.branch_name FROM tbl_spare_part a 
...
;";
    ...
    if ($user_level == 1 || $user_level == 2) {
        ...
        LEFT JOIN tbl_branch e ON c.branch_id = e.branch_id
        LEFT JOIN tbl_zone f ON e.zone_id = f.zone_id
