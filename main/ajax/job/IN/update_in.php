...
if ($_POST['appointment_date'] != "") {
    ...
    $sqldel2 = "DELETE FROM tbl_in_product WHERE job_id = '$job_id'";
    $rsdel2 = mysqli_query($connect_db, $sqldel2) or die($connect_db->error);
...
for ($c = 1; $c < $i; $c++) {
   ...
   $product_id = $temp_array_u[$c]['product_id'];
