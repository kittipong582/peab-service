...
$arr['product_type'] = "<label>ประเภทเครื่อง</label><br/><input type='text' class='form-control' readonly value='" . $row_product['type_name'] . "'>";
$arr['brand'] = "<label>ยี่ห้อ</label><br/><input type='text' class='form-control' readonly value='" . $row_product['brand_name'] . "'>";
$arr['model'] = "<label>รุ่น</label><br/><input type='text' class='form-control' readonly value='" . $row_product['model_name'] . "'>";
$arr['warranty_type'] = "<label>ประเภทประกัน</label><br/><input type='text' class='form-control' readonly value='" . $warranty_text . "'>";
