...
$check_type_respon_user = $_POST['mechanic'];
$respon_user_dealer = $_POST['dealer_mechanic'];
...
$condition = "";
if ($check_type_respon_user == 0) {
    $condition = "responsible_user_id = '$responsible_user_id'";
} elseif ($check_type_respon_user == 1) {
    $condition = "responsible_user_id = '$respon_user_dealer'";
}
...
for ($a = 1; $a < $i; $a++) {
    ...
    if ($rs_service) {
        ...
        $line_token = "3PJjW12Dw4UqUSsVSnx8fLTlU5pWpeNM65RlqBpib6A";
...
SET job_id = '$job_id'
,ref_job_id = '$job_ref'";
    $rs_ref = mysqli_query($connect_db, $sql_ref);
}
...
$condition2 = "";
if ($check_type_respon_user == 0) {
    $condition2 = "'$responsible_user_id'";
} elseif ($check_type_respon_user == 1) {
    $condition2 = "'$respon_user_dealer'";
}



$sql_line = "SELECT * FROM tbl_user WHERE user_id = '$condition2';";
// echo $sql_line . "<br>";
