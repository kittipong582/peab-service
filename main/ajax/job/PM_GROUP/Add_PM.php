...
//     echo $sql_group_pm = "INSERT INTO tbl_group_pm
...
//         if ($num_contact == 0) {
//             echo $insert_contact = "INSERT INTO tbl_customer_contact
...
//         echo $sql_update = "UPDATE tbl_job 
...
//             echo $sql_update_group = "UPDATE tbl_group_pm 
//                 SET responsible_user_id = '$responsible_user_id'
...
//             echo $sql_service = "INSERT INTO tbl_job_open_oth_service
//                         SET  job_id = '$job_id'
...
//             if ($staff != "") {
//                 echo  $sql_staff = "INSERT INTO tbl_job_staff
//                     SET job_id = '$job_id'
//                         ,staff_id = '$staff'
//                     ";
...
//         echo $sql_detail = "INSERT INTO tbl_group_pm_detail
//         SET  job_id = '$job_id'
//             ,group_pm_id = '$group_pm_id'
//         ";
