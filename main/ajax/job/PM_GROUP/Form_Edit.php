...
$sql = "SELECT *,a.remark AS Aremark,b.branch_name as team_name,d.customer_branch_id,e.customer_id AS eid FROM tbl_job a 
...
<div class="row mb-3">
    ...
    <div class="mb-3 col-2">
        <label>ลำดับ</label>
        <input type="text" class="form-control" id="list_pm_job" name="list_pm_job" value="<?php echo $row['list_pm_job'] ?>">
    </div>
    ...
    <div class="mb-3 col-3" id="user_list">
        ...
        <select class="form-control select2 mb-3" style="width: 100%;" name="responsible_user_id" id="responsible_user_id">
            ...
            <?php $sql_user = "SELECT * FROM tbl_user WHERE active_status = 1 and branch_id = '$care_branch_id'";
