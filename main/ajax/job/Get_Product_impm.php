...
LEFT JOIN tbl_product_model d ON c.brand_id = d.brand_id
...
if ($row_product['product_type'] == 1) {
    $product_type = 'เครื่องชง';
} else if ($row_product['product_type'] == 2) {
    $product_type = 'เครื่องบด';
} else if ($row_product['product_type'] == 3) {
...
$arr['product_type'] = $row_product['type_name'];
