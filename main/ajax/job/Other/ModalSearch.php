...
<script>
    ...
    function GetTable() {
        ...
        $.ajax({
            type: "POST",
            url: "ajax/job/Other/Get_Table_branch.php",
            data: {
    ...
    function Choose_Product(product_id, customer_branch_id) {

        $.ajax({
            type: "POST",
            url: "ajax/job/Other/GetCustomer.php",
            data: {
            ...
            success: function(response) {
                ...
                $.ajax({
                    type: "POST",
                    url: "ajax/job/Other/GetSelect_User.php",
                    data: {
                        branch_id: branch_id,
                    },
                    dataType: "html",
    ...
    // function Choose_customer_branch(customer_branch_id) {
    ...
    function Choose_customer(customer_branch_id) {
