        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <button class="btn btn-xs btn-primary btn-block" type="button" onclick="Choose_QT_Product('<?php echo $row['product_id'] ?>','<?php echo $row_branch['customer_branch_id'] ?>');">เลือก</button>
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-xs btn-primary btn-block" type="button" onclick="Choose_QT_customer('<?php echo $row['cus_id'] ?>','<?php echo $row['customer_branch_id'] ?>');">เลือก</button>
                        <!-- <a href="product_view_detail.php?id=<?php echo $product_id ?>" class="btn btn-xs btn-info btn-block">รายละเอียด</a> -->
                    </td>
