            ...
            <tr id="tr_<?php echo $row["expend_type_id"]; ?>">
                ...
                <td>
                    <div class="onoffswitch">
                        <input type="checkbox" class="onoffswitch-checkbox" <?php if($row["active_status"] == "1"){ echo "checked"; } ?> onchange='ChangeStatus(value,"expend_type_id","tbl_expend_type");' value="<?php echo $row["expend_type_id"]; ?>" id="StatusReq-<?php echo $row["expend_type_id"]; ?>">
                ...
                <td class="text-center pb-0">
                    <button class="btn btn-xs btn-block btn-warning" onclick="EditExpend('<?php echo $row['expend_type_id']; ?>');"><i class="fa fa-edit"></i> แก้ไข</button>
                </td>
            </tr>
        <?php } ?>
    </tbody>
