...
<form action="" method="post" id="form-add" enctype="multipart/form-data">
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">เพิ่มคู่มือการแก้ไขเบื้องต้น</h5>
    ...
    <div class="modal-body">
        <div class="row">
            <input type="text" hidden class="form-control mb-3" id="manual_id" name="manual_id" value="<?php echo $manual_id; ?>">
            <div class="col-6">
