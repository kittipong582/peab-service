...
<form action="" method="post" id="form-add-broken" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        <div class="row">
            <input type="text" hidden class="form-control mb-3" id="manual_id" name="manual_id"
                value="<?php echo $manual_id; ?>">

            <input type="text" hidden class="form-control mb-3" id="manual_sub_id" name="manual_sub_id"
                value="<?php echo $manual_sub_id; ?>">

            <input type="text" hidden class="form-control mb-3" id="model_id" name="model_id"
                value="<?php echo $model_id; ?>">

            <input type="text" hidden class="form-control mb-3" id="spare_broken_id" name="spare_broken_id"
            ...
            <div class="col-12">
                ...
                <select name="spare_type_id" id="spare_type_id" class="select2" onchange="Get_spare_type();">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary btn-sm" onclick="Add_broken('spare_part_id');">บันทึก</button>
        </div>
</form>
<script>
