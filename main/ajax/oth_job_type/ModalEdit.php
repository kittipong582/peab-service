...
<form action="" method="post" id="form-edit" enctype="multipart/form-data">
    <input type="text" hidden id="oth_type_id" name="oth_type_id" value="<?php echo $oth_type_id; ?>">
    ...
    <div class="modal-body">
        ...
        <input type="text" class="form-control mb-3" id="oth_type_name" name="oth_type_name" value="<?php echo $row['oth_type_name']; ?>">
