...
$sql = "SELECT COUNT(form_id) as Form_num FROM tbl_technical_form WHERE job_type = '$job_type' AND product_type = '$product_type'";
...
<form action="" method="post" id="form-add" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        <input type="hidden" class="form-control" id="job_type" name="job_type" value="<?php echo $job_type ?>" readonly>
        ...
        <div class="row">
            ...
            <div class="col-2 mb-3">
                ...
                <input type="checkbox" class="icheckbox_square-green chkbox" disabled value="0" name="have_remark" id="have_remark">
                <label></label>
