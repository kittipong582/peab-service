...
$sql_job = "SELECT COUNT(*) AS total_job FROM tbl_job WHERE YEAR(appointment_date) = '$year' AND job_type = '2'";
...
$sql_job_finish = "SELECT COUNT(*) AS total_finish FROM tbl_job WHERE YEAR(appointment_date) = '$year' AND job_type = '2'
