...
$sql_overhaul = "SELECT * FROM tbl_overhaul WHERE not overhaul_id = '$overhaul_id' AND current_branch_id = '$branch_id' AND current_customer_branch_id IS NULL and active_status = 1";
...
<form action="" method="post" id="form-add_overhaul" enctype="multipart/form-data">
    ...
    <div class="modal-footer">
        <button class="btn btn-primary btn-sm" type="button" id="submit" onclick="submit_change()">บันทึก</button>
...
<script>
    ...
    function submit_change() {
        ...
        swal({
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax/CM_view/overhaul/change_overhaul.php',
                data: formData,
                processData: false,
                contentType: false,
                dataType: 'json',
