...
foreach ($files_name as $key) {
    ...
    $sql = "SELECT COUNT(img_id) AS order_list FROM tbl_pm_image WHERE job_id = '$job_id'";
    ...
    if ($file_surname_1 == 'jpg' || $file_surname_1 == 'jpeg' || $file_surname_1 == 'gif' || $file_surname_1 == 'png' || $file_surname_1 == 'JPG' || $file_surname_1 == 'JPEG' || $file_surname_1 == 'GIF' || $file_surname_1 == 'PNG') {
        ...
        if (move_uploaded_file($files_tmp, "../../../upload/pm_image/" . $filename_images_1)) {


            $file_Path = __DIR__ . '/../../../upload/pm_image/' . $filename_images_1;
