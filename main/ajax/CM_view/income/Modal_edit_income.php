    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-6 mb-3">
                ...
                <select class="form-control select2" style="width: 100%;" id="income_type_id" onchange="get_des(this.value),get_cost(this.value)" name="income_type_id">
            ...
            <div class="col-6 mb-3">
                ...
                <input type="text" class="form-control" id="amount" value="<?php echo $row['unit_cost']; ?>" name="amount">
            </div>
