...
<form action="" method="post" id="form_qc" enctype="multipart/form-data">
    ...
    <div class="modal-body" style="padding-bottom: 0;">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="input-group">
                    <input type="radio" class="iradio_square-green" id="sub_oh_type" name="sub_oh_type" value="1"><label style="font-size: 13px; padding-right: 8px;">&nbsp;รับเครื่องสำรอง </label>
                      <input type="radio" class="iradio_square-green" id="sub_oh_type" name="sub_oh_type" value="2"><label style="font-size: 13px; padding-right: 8px;">&nbsp;วางเครื่องสำรอง </label>

                    <input type="radio" class="iradio_square-green" id="sub_oh_type" name="sub_oh_type" value="3"><label style="font-size: 13px; padding-right: 8px;">&nbsp;ไม่รับเครื่องสำรอง </label>
                </div>
            </div>
...
<div class="modal-footer">
    ...
    <button class="btn btn-success btn-sm" type="button" id="submit" onclick="Submit_gs_overhaul()">บันทึก</button>
</div>
...
<script>
    ...
    function Submit_gs_overhaul() {
        ...
        swal({
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax/CM_view/close_record/Add_gs_oh.php',
                data: formData,
                processData: false,
                contentType: false,
                dataType: 'json',
