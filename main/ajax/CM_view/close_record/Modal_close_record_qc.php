        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="input-group">
                    <input type="radio" class="iradio_square-green" id="oh_type" name="oh_type" value="1"><label style="font-size: 13px; padding-right: 8px;">&nbsp;เครื่องสำรอง </label>
                      <input type="radio" class="iradio_square-green" id="oh_type" name="oh_type" value="2"><label style="font-size: 13px; padding-right: 8px;">&nbsp;QC เครื่องสำรอง </label>
                </div>
            </div>
...
<script>
    ...
    function Submit_qc_overhaul() {
        ...
        swal({
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax/CM_view/close_record/Add_qc_oh.php',
                data: formData,
                processData: false,
                contentType: false,
                dataType: 'json',
