...
$sql_check = "SELECT approve_result FROM tbl_job_quotation_approve WHERE job_id = '$job_id' ORDER BY create_datetime DESC";
...
if ($row_check['approve_result'] != 1) {
    ...
    $sql_update = "UPDATE tbl_job_quotation_approve
    ...
    $sql_cancel = "INSERT INTO tbl_job_quotation_approve
                SET  quotation_approve_id = '$quotation_approve_id'
