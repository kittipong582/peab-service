...
$job_id = $_POST['job_id'];
$sql = "SELECT * FROM tbl_job_close_approve WHERE job_id = '$job_id' and approve_result = 0 ORDER BY create_datetime DESC LIMIT 1";
...
<form action="" method="post" id="form-add_close_app" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <input id="close_approve_id" name="close_approve_id" value="<?php echo $row['close_approve_id'] ?>" type="hidden">
    ...
    <div class="modal-footer">
        <button class="btn btn-primary btn-md " type="button" onclick="APP_close()">บันทึก</button>
...
<script>
    ...
    function APP_close() {
        ...
        swal({
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax/CM_view/job_close_approve/Add_approve.php',
                data: formData,
                processData: false,
                contentType: false,
                dataType: 'json',
