...
if ($result == 1) {
    ...
    $sql_type = "SELECT adjust_type,receive_branch_id FROM tbl_adjust_head WHERE adjust_id = '$adjust_id'";
    $rs_type  = mysqli_query($connection, $sql_type) or die($connection->error);
    $row_type = mysqli_fetch_assoc($rs_type);
    $branch_id = $row_type['receive_branch_id'];
    ...
    if ($row_type['adjust_type'] == 1) {
        ...
        while ($row_detail = mysqli_fetch_assoc($rs_detail)) {
            ...
            $sql_chk = "SELECT remain_stock FROM tbl_branch_stock WHERE spare_part_id = '$ax' AND branch_id = '$branch_id' ;";
            ...
            $sql_user_stock = "UPDATE tbl_branch_stock
                ...
                WHERE spare_part_id = '$ax' AND branch_id = '$branch_id'
                ;";
