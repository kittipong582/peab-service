...
<div name="div_ax[]" id="div_<?php echo $i; ?>" value="<?php echo $i; ?>">
    <div class="col-lg-12">
        <div class="row">
            ...
            <div class="col-mb-4 col-xs-4 col-sm-4" id="get_stock">
                <label>อะไหล่</label>
                <select name="ax[]" id="ax_<?php echo $i; ?>" class="form-control select2" onchange="GetRemain(this.value,'<?php echo $i ?>','<?php echo $branch_id ?>'),chk(<?php echo $i; ?>);">
