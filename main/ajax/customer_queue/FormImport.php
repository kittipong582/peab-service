<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLongTitle"><strong>นำเข้าคิว</strong></h5>
...
<div class="modal-body">
    ...
    <div class="modal-footer">
        <a href="../main/file/_OH.xlsx" target="_blank" rel="noopener noreferrer" download><button type="button"
                class="btn btn-info"><i class="fa fa-download"></i> Import Form</button></a>
