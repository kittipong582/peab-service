...
$sql = "SELECT * FROM tbl_job_evaluate WHERE evaluate_id = '$evaluate_id'";
...
<form action="" method="post" id="form-edit" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        <input type="hidden" class="form-control" id="evaluate_id" name="evaluate_id" value="<?php echo $evaluate_id ?>"
            readonly>
        <div class="row">
            <div class="col-2 mb-3">
                <label>ข้อ</label>
                <input type="text" class="form-control" name="list_order" value="<?php echo $row['list_order'] ?>"
                    readonly>
            </div>

            <div class="col-4 mb-3">
                <label>หัวข้อแบบประเมินความพึ่งพอใจ</label><br>
                <input type="text" class="form-control" id="detail" name="detail" value="<?php echo $row['detail'] ?>">
            ...
            <div class="col-2 mb-3">
                ...
                <input type="checkbox" class="icheckbox_square-green chkbox"
                    <?php echo ($row['have_remark'] == 1) ? 'CHECKED' : ''; ?> value="<?php echo $row['have_remark'] ?>"
                    name="have_remark" id="have_remark">
                <label></label>
