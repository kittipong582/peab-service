<?php
    ...
    $create_user_id = $_SESSION['user_id'];
        ...
        $sql = "INSERT INTO tbl_customer_daily_record
    SET  
        daily_id = '$daily_id'
...
if ($_FILES['file_name'] != "") {
    ...
    if ($file_surname_1 == 'pdf' || $file_surname_1 == 'jpg' || $file_surname_1 == 'jpeg' || $file_surname_1 == 'png' || $file_surname_1 == 'PDF' || $file_surname_1 == 'JPG' || $file_surname_1 == 'JPEG' || $file_surname_1== 'PNG'
        ...
        if (move_uploaded_file($_FILES['file_name']['tmp_name'],"../../upload/".$filename_images_1)) {
            ...
            $sql4 = "UPDATE tbl_customer_daily_record SET record_file = '$filename_images_1' WHERE daily_id = '$daily_id'";
            
            $rs4 = mysqli_query($connection, $sql4) or die($connection->error);
