...
$user_id = CreateUser($username, $newpassword, $fullname);
...
if ($user_id) {
    ...
    if ($user_level == 9) {
        $sql_update_user .= ", admin_status = '9', branch_id = '$branch_id' ";
    } else if ($user_level == 4) {
        $sql_update_user .= ", user_level = '$user_level', admin_status = '9' ";
    } else if ($user_level == 5) {
        $sql_update_user .= ", user_level = '$user_level', branch_id = '$branch_id', dealer_status = '1' ";
    } else {
        if ($user_level == 3) {
            $sql_update_user .= ", admin_status = '9' ";
        }
        $sql_update_user .= ", user_level = '$user_level', branch_id = '$branch_id' ";
    }
