...
$sql = "SELECT MAX(list_order) as last_list_order FROM tbl_product_edit_manual_sub WHERE manual_id = '$manual_id'";
...
$sql_insert = "INSERT INTO tbl_product_edit_manual_sub SET 
