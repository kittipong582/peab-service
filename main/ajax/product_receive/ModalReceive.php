...
$sql = "SELECT * FROM tbl_product_transfer WHERE transfer_id = '$transfer_id'";
...
<form action="" method="post" id="form-transfer" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        <div class="row">
            <input type="hidden" id="transfer_id" name="transfer_id" value="<?php echo $row['transfer_id'] ?>">
    ...
    function Transfer() {
        ...
        swal({
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "ajax/product_receive/Receive.php",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function(response) {
                    if (response.result == 1) {
                        swal({
                            ...
                            swal.close();
                            $("#modal").modal('hide');
                            location.href = "product.php?id="+response.branch_id;
