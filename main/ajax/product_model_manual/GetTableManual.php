...
$sql = "SELECT * FROM tbl_spare_part_manual WHERE model_id = '$model_id'";
$res = mysqli_query($connect_db, $sql);


?>

<table class="table table-striped table-bordered table-hover" id="table_manual_">
    <thead>
        <tr>
            ...
            <tr>
                ...
                <td>
                    <div class='form-group'>
                        <a href='manual_spare_part.php?id=<?php echo $row['manual_id']; ?>&model_id=<?php echo $row['model_id']; ?>'><button
