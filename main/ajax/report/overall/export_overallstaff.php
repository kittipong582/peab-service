...
if ($_POST['job_type'] == 'x' || $_POST['job_type'] == 2) {
    ...
    WHERE a.job_id = '{$row_check['job_id']}' ;";
        ...
        // $worktime_hours = floor($interval_seconds / 3600); 
        // $worktime_minutes = round(($interval_seconds % 3600) / 60); 

       
        // $worktime = $worktime_hours . ' : ' . $worktime_minutes;
        ...
        $worktime_hours = floor($interval_seconds / 60); // แปลงเป็นชั่วโมง
        $worktime = $worktime_hours;
...
//ตั้งชื่อไฟล์
$file_name = "ReportOverallStaff" . "_" . date("d-m-Y H:i:s");
//
