...
if ($_POST['job_type'] == 'x' || $_POST['job_type'] == 2) {
    ...
    LEFT JOIN tbl_product h ON a.product_id = h.product_id  
     WHERE j.group_pm_id = '{$row_chk['group_pm_id']}';";
        ...
        // $worktime_minutes = ($interval_seconds % 3600) / 60; // แปลงเป็นนาทีและคิดเป็นเศษนาทีที่เหลือ
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue($columnCharacter[12] . $rowCell, 'ระยะเวลาทำงาน');
