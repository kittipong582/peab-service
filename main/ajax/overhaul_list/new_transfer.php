                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <!-- <font color="red">**</font> -->
                                                <select class="form-control select2" id="from_branch" name="from_branch"
                                        ...
                                        <div class="col-md-3 col-xs-12 col-sm-12" id="get_user2">
                                            <div class="form-group">
                                                <label>ผู้รับ</label>
                                                <font color="red">**</font>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date">
                                                    ...
                                                    <input class="form-control datepicker" type="text"
                                                        name="withdraw_date" id="withdraw_date" value="">
                                                </div>
                                            </div>
                                        </div>
...
function submit_withdraw() {
    ...
    if (from_branch != to_branch) {
        ...
        if (ax_ref_no == "" || withdraw_date == "") {
            swal({
                title: 'เกิดข้อผิดพลาด',
                text: 'กรุณาระบุหมายเลข AX และวันที่เบิกให้ครบถ้วน',
                type: 'error'
            });
            return false;
        }
