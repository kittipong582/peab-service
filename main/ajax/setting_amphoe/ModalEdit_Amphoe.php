...
$sql = "SELECT ref_province,amphoe_name_th,amphoe_name_en FROM tbl_amphoe WHERE amphoe_id ='$amphoe_id'";
...
<form action="" method="post" id="form-update" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        <div class="row">
            <input type="hidden" value="<?php echo $row['ref_province']  ?>" id="ref_province" name="ref_province">
            ...
            <div class="col-12 mb-3">
                ...
                <font color="red">**</font>
                <input type="text" class="form-control mb-3" value="<?php echo $row['amphoe_name_th']  ?>" id="amphoe_name_th" name="amphoe_name_th">
            </div>
            <div class="col-12 mb-3">
                <label for="model_id">
                    ชื่อเขต/อำเภอ (EN)
                ...
                <font color="red">**</font>
                <input type="text" class="form-control mb-3" value="<?php echo $row['amphoe_name_en']  ?>" id="amphoe_name_en" name="amphoe_name_en">
            </div>
        </div>
    ...
    function Update() {
        ...
        swal({
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "ajax/setting_amphoe/Update_Amphoe.php",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
