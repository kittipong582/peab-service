                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <div>
                                ...
                                <?php
                                $sql_product = "SELECT a.*,b.model_code,b.model_name,c.product_type FROM tbl_product_waiting a LEFT JOIN tbl_product_model b ON a.model_code = b.model_code LEFT JOIN tbl_product c ON b.model_id = c.model_id WHERE lot_id = '$lot_id'";
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-3">
                            ...
                            <div class="input-group w-100">
                                <select class="select2" name="machine_status" id="machine_status">
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <div class="d-flex">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-primary ml-2" onclick="add_row_staff();"><i class="fa fa-plus"></i> เพิ่ม</button>
                            </div>
                        </div>
                        <div class="col-6">
                            <!-- ไม่มีส่วนที่ต้องใส่ปุ่มต่อ -->
                        </div>
                    </div>
