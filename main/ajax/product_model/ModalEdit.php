    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <input type="text" class="form-control mb-3" id="model_code" value="<?php echo $row['model_code']; ?>" name="model_code">
            </div>
            ...
            <div class="col-6">
                ...
                <input type="text" class="form-control mb-3" id="model_name" name="model_name" value="<?php echo $row['model_name']; ?>">
            </div>
