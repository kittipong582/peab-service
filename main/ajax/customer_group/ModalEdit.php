    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-6 mb-3">
                ...
                <input type="text" class="form-control mb-3" id="group_name" value="<?php echo $row['customer_group_name'] ?>" name="group_name">
            </div>
            ...
            <div class="col-6 mb-3">
                ...
                <div class="input-group date">
                    ...
                    <input type="text" id="expire_date" readonly name="expire_date" value="<?php echo date("d-m-Y", strtotime($row['expire_date'])) ?>" class="form-control datepicker" value="" autocomplete="off">
                </div>
            </div>
        </div>
