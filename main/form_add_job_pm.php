...
<script>
    ...
    function addPMForm() {
        ...
        $.ajax({
            type: 'POST',
            url: "ajax/job/PM_GROUP/addPMForm.php",
            dataType: "html",
            data: {
                Count_Row: increment,
    ...
    function create_plan() {
        ...
        $.ajax({
            type: 'POST',
            url: "ajax/job/PM_GROUP/addPM_MultiForm.php",
            dataType: "html",
            data: {
                Count_Row: PMcounter,
    ...
    function Other_care_PM(row) {
        $.ajax({
            type: "post",
            url: "ajax/job/PM_GROUP/ModalOther_Care.php",
            data: {
                row: row,
            },
            dataType: "html",
    ...
    function check_job_pm(date, row) {
        ...
        var customer_branch_id = $('#customer_branch_id').val();
        $.ajax({
            url: 'ajax/job/PM_GROUP/Check_Pm_job.php',
            type: 'POST',
            dataType: 'json',
            data: {
                date: date,
    ...
    function get_Pm_care(branch_id, i) {
        ...
        $.ajax({
            type: "POST",
            url: "ajax/job/PM_GROUP/GetSelect_PM_User.php",
            data: {
                branch_id: branch_id,
            },
            dataType: "html",
