...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="manual_list.php">คู่มือ</a>
            </li>
...
<script>
    ...
    function GetTable() {
        ...
        $.ajax({
            type: "post",
            url: "ajax/manual_sub/GetTable.php",
            dataType: "html",
            data: {
                manual_id: manual_id
            },
    ...
    function ModalAdd() {
        ...
        const manual_id = urlParams.get('id');
        $.ajax({
            url: "ajax/manual_sub/ModalAdd.php",
            data: {
                manual_id: manual_id
            },
            dataType: "html",
    ...
    function ModalEdit(manual_sub_id) {
        ...
        $.ajax({
            type: "post",
            url: "ajax/manual_sub/ModalEdit.php",
            data: {
    ...
    function Update() {
        ...
        swal({
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax/manual_sub/Update.php',
                data: formData,
                processData: false,
                contentType: false,
                dataType: 'json',
