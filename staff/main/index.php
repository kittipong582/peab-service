...
$sql_blacklog = "SELECT COUNT(job_id) AS c_job_blacklog FROM `tbl_job` WHERE responsible_user_id = '$user_id' AND close_datetime IS NULL;";
        ...
        <div class="col-12 p-2">
            <a href="blacklog.php" class="widget style1 bg-warning m-0 block">
                <div class="row">
                    ...
                    <div class="col-8 text-right">
                        <span> งานงานค้างทั้งหมด </span>
                        <h2 class="font-bold"><?php echo $row_blacklog['c_job_blacklog'] ?></h2>
                    </div>
                </div>
            </a>
        </div>
