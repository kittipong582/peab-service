    ...
    <div class="ibox mb-1 d-block border">
        ...
        <div class="ibox-content">
            ...
            <div class="text-center mt-3">
                <div class="btn-group">
                    <a href="https://peabery-upload.s3.ap-southeast-1.amazonaws.com/<?php echo $row_manual_sub['file_name']; ?>" target="_blank" class="btn btn-info mr-2">ไฟล์</a>
                    <!-- <button class="btn btn-primary mr-2" onclick="ModalAddbroken('<?php echo $row_manual_sub['manual_sub_id'] ?>')">เพิ่มอะไหล่</button> -->
                    <button class="btn btn-success" onclick="Modal_Detail('<?php echo $row_manual_sub['manual_sub_id'] ?>')">อะไหล่</button>
                </div>
            </div>
        </div>
...
<script>
    ...
    function Modal_Detail(manual_sub_id) {
        ...
        $.ajax({
            url: "ajax/manual_basic_sub/Modal_detail.php",
            data: {
                manual_id: manual_id,
                manual_sub_id: manual_sub_id,
                model_id: model_id
    ...
    function Delete(spare_broken_id) {
        ...
        swal({
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax/manual_basic_sub/Delete.php',
                data: {
