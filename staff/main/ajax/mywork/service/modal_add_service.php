    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-6 mb-3">
                ...
                <select class="form-control select2" id="income_type_id" style="width: 100%;" onchange="get_des(this.value),get_cost(this.value)" name="income_type_id">
...
<script>
    ...
    function get_cost(income_id) {
        $.ajax({
            url: 'ajax/mywork/service/Get_cost.php',
            type: 'POST',
            dataType: 'json',
            data: {
                income_id: income_id,
