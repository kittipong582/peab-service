...
$sql = "SELECT a.payment_id,a.job_id,a.ref_type,d.customer_id,b.job_type,d.bill_type,d.business_group_id,a.cash_amount,a.transfer_amount,a.account_id,a.customer_cost,a.remark FROM tbl_job_payment_file a
...
<form action="" method="post" id="form-edit_payment" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-12 mb-3" id="transfer">
                ...
                <input type="text" id="customer_cost" onchange="chk_total()" name="customer_cost" value="<?php echo $row['customer_cost']; ?>" class="form-control">
            </div>
            ...
            <div class="col-12 mb-3" id="cash">
                ...
                <font color="red">**</font><br>
                <input type="text" id="branch_cost" onchange="chk_total()" name="branch_cost" value="<?php echo $edit_branch_amount ?>" class="form-control">
            </div>
            ...
            <div class="col-12 mb-3" id="cash">
                ...
                <font color="red">**</font><br>
                <input type="text" id="cash_amount" onchange="check_amount()" name="cash_amount" value="<?php echo $row['cash_amount'] ?>" class="form-control">
            </div>
            <div class="col-12 mb-3" id="transfer">
                <label for="quantity">
                    เงินโอน
                ...
                <font color="red">**</font><br>
                <input type="text" id="transfer_amount" onchange="check_amount()" name="transfer_amount" value="<?php echo $row['transfer_amount'] ?>" class="form-control">
            </div>
            ...
            <div class="col-12 mb-3">
                ...
                <div class="row">
                    ...
                    <?php $sql_img = "SELECT * FROM tbl_job_payment_img WHERE payment_id = '{$row['payment_id']}'";
                    $result_img  = mysqli_query($connect_db, $sql_img);
                    while ($row_img = mysqli_fetch_array($result_img)) {
                    ?>
                        <div class="col-3">
                            <img id="blah" style="border:0px;margin:2px;" src="https://peabery-upload.s3.ap-southeast-1.amazonaws.com/<?php echo $row_img['img_id'] ?>" width="100" height="150" />
    ...
    <div class="modal-footer">
        <button class="btn btn-primary px-5" type="button" id="submit" onclick="Update_payment()">บันทึก</button>
    </div>
</form>
