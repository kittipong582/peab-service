...
<form action="" method="post" id="form_upqc" enctype="multipart/form-data">
    ...
    <div class="modal-body" style="padding-bottom: 0;">
        ...
        <input type="hidden" id="form_id" name="form_id" value="<?php echo $form_id; ?>"></input>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="input-group">
                    <input type="radio" class="iradio_square-green" id="oh_detail" name="oh_detail" value="1" <?php echo ($row['sub_oh_type'] == 1) ?  "checked" : "";  ?>><label style="font-size: 13px; padding-right: 8px;">&nbsp;รับเครื่องสำรอง </label>
                      <input type="radio" class="iradio_square-green" id="oh_detail" name="oh_detail" value="2" <?php echo ($row['sub_oh_type'] == 2) ?  "checked" : "";  ?>><label style="font-size: 13px; padding-right: 8px;">&nbsp;วางเครื่องสำรอง </label>
                </div>
                <div class="input-group">
                    <input type="radio" class="iradio_square-green" id="oh_detail" name="oh_detail" value="3" <?php echo ($row['sub_oh_type'] == 3) ?  "checked" : "";  ?>><label style="font-size: 13px; padding-right: 8px;">&nbsp;ไม่รับเครื่องสำรอง </label>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no1_detail" name="no1_detail" value="<?php  echo $row['no1_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no1_spare_detail" name="no1_spare_detail" value="<?php  echo $row['no1_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no2_detail" name="no2_detail" value="<?php  echo $row['no2_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no2_spare_detail" name="no2_spare_detail" value="<?php  echo $row['no2_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no3_detail" name="no3_detail" value="<?php  echo $row['no3_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no3_spare_detail" name="no3_spare_detail" value="<?php  echo $row['no3_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no4_detail" name="no4_detail" value="<?php  echo $row['no4_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no4_spare_detail" name="no4_spare_detail" value="<?php  echo $row['no4_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no5_detail" name="no5_detail" value="<?php  echo $row['no5_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no5_spare_detail" name="no5_spare_detail" value="<?php  echo $row['no5_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no6_detail" name="no6_detail" value="<?php  echo $row['no6_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no6_spare_detail" name="no6_spare_detail" value="<?php  echo $row['no6_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no7_detail" name="no7_detail" value="<?php  echo $row['no7_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no7_spare_detail" name="no7_spare_detail" value="<?php  echo $row['no7_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no8_detail" name="no8_detail" value="<?php  echo $row['no8_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no8_spare_detail" name="no8_spare_detail" value="<?php  echo $row['no8_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no9_detail" name="no9_detail" value="<?php  echo $row['no9_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no9_spare_detail" name="no9_spare_detail" value="<?php  echo $row['no9_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no10_detail" name="no10_detail" value="<?php  echo $row['no10_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no10_spare_detail" name="no10_spare_detail" value="<?php  echo $row['no10_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no11_detail" name="no11_detail" value="<?php  echo $row['no11_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no11_spare_detail" name="no11_spare_detail" value="<?php  echo $row['no11_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no12_detail" name="no12_detail" value="<?php  echo $row['no12_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no12_spare_detail" name="no12_spare_detail" value="<?php  echo $row['no12_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no13_detail" name="no13_detail" value="<?php  echo $row['no13_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no13_spare_detail" name="no13_spare_detail" value="<?php  echo $row['no13_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no14_detail" name="no14_detail" value="<?php  echo $row['no14_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no14_spare_detail" name="no14_spare_detail" value="<?php  echo $row['no14_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no15_detail" name="no15_detail" value="<?php  echo $row['no15_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no15_spare_detail" name="no15_spare_detail" value="<?php  echo $row['no15_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no16_detail" name="no16_detail" value="<?php  echo $row['no16_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no16_spare_detail" name="no16_spare_detail" value="<?php  echo $row['no16_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no17_detail" name="no17_detail" value="<?php  echo $row['no17_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no17_spare_detail" name="no17_spare_detail" value="<?php  echo $row['no17_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no18_detail" name="no18_detail" value="<?php  echo $row['no18_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no18_spare_detail" name="no18_spare_detail" value="<?php  echo $row['no18_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no19_detail" name="no19_detail" value="<?php  echo $row['no19_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no19_spare_detail" name="no19_spare_detail" value="<?php  echo $row['no19_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no20_detail" name="no20_detail" value="<?php  echo $row['no20_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no20_spare_detail" name="no20_spare_detail" value="<?php  echo $row['no20_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no21_detail" name="no21_detail" value="<?php  echo $row['no21_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no21_spare_detail" name="no21_spare_detail" value="<?php  echo $row['no21_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no22_detail" name="no22_detail" value="<?php  echo $row['no22_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no22_spare_detail" name="no22_spare_detail" value="<?php  echo $row['no22_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no23_detail" name="no23_detail" value="<?php  echo $row['no23_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no23_spare_detail" name="no23_spare_detail" value="<?php  echo $row['no23_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no24_detail" name="no24_detail" value="<?php  echo $row['no24_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no24_spare_detail" name="no24_spare_detail" value="<?php  echo $row['no24_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no25_detail" name="no25_detail" value="<?php  echo $row['no25_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no25_spare_detail" name="no25_spare_detail" value="<?php  echo $row['no25_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no26_detail" name="no26_detail" value="<?php  echo $row['no26_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no26_spare_detail" name="no26_spare_detail" value="<?php  echo $row['no26_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no27_detail" name="no27_detail" value="<?php  echo $row['no27_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no27_spare_detail" name="no27_spare_detail" value="<?php  echo $row['no27_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no28_detail" name="no28_detail" value="<?php  echo $row['no28_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no28_spare_detail" name="no28_spare_detail" value="<?php  echo $row['no28_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no29_detail" name="no29_detail" value="<?php  echo $row['no29_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no29_spare_detail" name="no29_spare_detail" value="<?php  echo $row['no29_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no30_detail" name="no30_detail" value="<?php  echo $row['no30_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no30_spare_detail" name="no30_spare_detail" value="<?php  echo $row['no30_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no31_detail" name="no31_detail" value="<?php  echo $row['no31_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no31_spare_detail" name="no31_spare_detail" value="<?php  echo $row['no31_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no32_detail" name="no32_detail" value="<?php  echo $row['no32_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no32_spare_detail" name="no32_spare_detail" value="<?php  echo $row['no32_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no33_detail" name="no33_detail" value="<?php  echo $row['no33_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no33_spare_detail" name="no33_spare_detail" value="<?php  echo $row['no33_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="choice_no34_detail" name="choice_no34_detail" value="<?php  echo $row['choice_no34_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no34_spare_detail" name="no34_spare_detail" value="<?php  echo $row['no34_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no35_detail" name="no35_detail" value="<?php  echo $row['no35_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no35_spare_detail" name="no35_spare_detail" value="<?php  echo $row['no35_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no36_detail" name="no36_detail" value="<?php  echo $row['no36_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no36_spare_detail" name="no36_spare_detail" value="<?php  echo $row['no36_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no37_detail" name="no37_detail" value="<?php  echo $row['no37_detail']?>" placeholder="หมายเหตุ">
                    </div>
                    ...
                    <div class="col-12 form-group">
                        <input type="text" class="form-control" id="no37_spare_detail" name="no37_spare_detail" value="<?php  echo $row['no37_spare_detail']?>" placeholder="หมายเหตุ">
                    </div>
...
<div class="modal-footer">
    ...
    <button class="btn btn-success btn-sm" type="button" id="submit" onclick="Submit_update()">บันทึก</button>
</div>
...
<script>
    ...
    function Submit_update() {
        ...
        var formData = new FormData($("#form_upqc")[0]);
        ...
        swal({
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax/mywork/record_pickup/update_pickup.php',
                data: formData,
                processData: false,
                contentType: false,
                dataType: 'json',
