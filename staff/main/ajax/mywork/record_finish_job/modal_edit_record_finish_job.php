...
// echo $sql_form;
$sql_remark = "SELECT remark FROM tbl_job_form_remark WHERE job_id = '$job_id' AND product_id = '$product_id'";
$resultl_remark  = mysqli_query($connect_db, $sql_remark);
$row_remark = mysqli_fetch_array($resultl_remark);
...
<script>
    ...
    function Submit_close_record() {
        ...
        swal({
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax/mywork/record_finish_job/update.php',
                data: formData,
                processData: false,
                contentType: false,
                dataType: 'json',
