...
<div class="modal-header">
    <h4 class="modal-title" id="exampleModalLabel">บันทึกออกงาน</h4>
    ...
    <div class="modal-body" style="padding-bottom: 0;">
        ...
        <div class="row">
            <div class="col-md-12 form-group">
                <label><strong>หลักฐานการบันทึกออกงาน </strong>
                    <font class="text-danger">**</font>
                </label>
                <div class="custom-file">
                    <input type="file" class="form-control" id="anyfile" name="anyfile" onchange="readURL2(this);">
                </div>
            </div>
        </div>
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary btn-sm" onclick="submit_checkout();"><i class="fa fa-check"></i>
        ยืนยัน</button>
</div>
