...
<form id="frm_audit" enctype="multipart/form-data">
            ...
            ?>
                <div class="form-check">
                    ...
                    <label class="form-check-label ml-3" for="score<?php echo $row_list['score_name']; ?>">
                        <span style="font-size: 20pt;"><?php echo $row_list['score_name']; ?></span>
                    </label>
                </div>
            <?php } ?>
        <?php } ?>
    ...
    <section class="mb-3">
                        ...
                        <div class="form-group">
                            <div class="BroweForFile">
                                <div id="show_image<?php echo $i; ?>"><label for="produce_img<?php echo $i; ?>">
                                        <a><img id="blah<?php echo $i; ?>" src="<?php echo ($row_record_img['file_part'] != '') ? 'https://peabery-upload.s3.ap-southeast-1.amazonaws.com/' . $row_record_img['file_part'] : 'upload/No-Image.png' ?>" width="100%" /></a></label>
                                </div><br />
        ...
        <label for=""><span style="font-size: 15pt;">รายละเอียด</span></label>
        <textarea name="remark" id="remark" cols="30" rows="5" class="form-control"><?php echo $remark; ?></textarea>
    </section>
</form>
