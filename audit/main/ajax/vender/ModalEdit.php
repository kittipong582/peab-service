            ...
            <div class="col-12 mb-3">
                <div class="text-center mb-3">
                    ...
                    <input type="file" class="form-control" name="profile_image" id="profile_image"
                        onchange="ImageReadURL(this,value,'#show_file','upload/<?php echo $profile_image; ?>');">
                </div>
                ...
                <input type="text" class="form-control mb-3" id="mobile_phone" name="mobile_phone"
                    value="<?php echo $row['mobile_phone']; ?>">
                ...
                <input type="text" class="form-control mb-3" id="line_token" name="line_token"
                    value="<?php echo $row['line_token']; ?>">


                <input class="icheckbox_square-green mb-3" <?php echo ($row['line_active'] == 1) ? 'checked' : ''; ?>
                    type="checkbox" name="chkbox" id="chkbox" value="chkbox">
                <label for="line_active" class="mb-3">
                    รับการแจ้งเตือน
                </label>
                <input type="hidden" id="line_active" name="line_active" value="<?php echo $row['line_active'] ?>"
                    style="position: absolute; opacity: 0;"><br>
