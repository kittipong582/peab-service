    ...
    <div class="row m-0 p-1">
        <div class="col-12 p-2">
            ...
            <div>
                ...
                <img src="<?php echo ($signature_image != '') ? 'https://peabery-upload.s3.ap-southeast-1.amazonaws.com/' . $signature_image : 'upload/no-img.png' ?>" width="100%" style="border: 1wpx solid #000;"/>
            </div>
