...
<script>
    ...
    function GetModalStart(group_id) {
        ...
        $("#myModal").modal("show");
        $("#showModal").load("ajax/my_work/modal_start.php", {
            group_id: group_id,
        });
    }
    ...
    function Start_Audit(job_id, audit_id, group_id) {
        ...
        swal({
            ...
            $.ajax({
                type: "POST",
                url: "ajax/my_work/Update_Start.php",
                data: {
                    job_id: job_id,
                    audit_id: audit_id,
                    group_id: group_id
    ...
    function ModalClose(group_id) {
        $("#myModal").modal("show");
        $("#showModal").load("ajax/my_work/close_audit.php", {
            group_id: group_id
        });
    }
    ...
    function SubmitColseJob(group_id) {
        ...
        if (sig_validate == 0) {
            ...
            swal({
                ...
                $.ajax({
                    type: "POST",
                    url: "ajax/my_work/update_close_job.php",
                    data: {
                        group_id: group_id,
                        signature: img_data
                    },
                    ...
                    success: function(data) {
                        if (data.result == 1) {
                            swal({
                                ...
                                swal.close();
                                $("#myModal").modal('hide');
                                window.location.href = 'my_work.php';
                            });
                        } else if (data.result == 0) {
                            swal({
                                title: 'แจ้งเตือน',
